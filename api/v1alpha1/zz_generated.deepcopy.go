...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RestoreActions) DeepCopyInto(out *RestoreActions) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RestoreActions.
func (in *RestoreActions) DeepCopy() *RestoreActions {
	if in == nil {
		return nil
	}
	out := new(RestoreActions)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VeleroImportSpec) DeepCopyInto(out *VeleroImportSpec) {
	*out = *in
	...
	if in.DataImportRef != nil {
		in, out := &in.DataImportRef, &out.DataImportRef
		*out = new(v1.ObjectReference)
		**out = **in
	}
