...
//+kubebuilder:rbac:groups=migration.yinhestor.com,resources=dataimports,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=migration.yinhestor.com,resources=dataimports/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=migration.yinhestor.com,resources=dataimports/finalizers,verbs=update
...
func (r *DataImportReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&migrationv1alpha1.DataImport{}).
		Complete(r)
}
